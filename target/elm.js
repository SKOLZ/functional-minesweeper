...
Elm.Tile.make = function (_elm) {
   "use strict";
   _elm.Tile = _elm.Tile || {};
   if (_elm.Tile.values) return _elm.Tile.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
...
Elm.Utils.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var customOptions = {stopPropagation: false,preventDefault: true};
   var onRightClick = F2(function (address,msg) {
      return A4($Html$Events.onWithOptions,"contextmenu",customOptions,$Json$Decode.value,function (_p0) {    return A2($Signal.message,address,msg);});
   });
   return _elm.Utils.values = {_op: _op,customOptions: customOptions,onRightClick: onRightClick};
};
...
Elm.Minefield = Elm.Minefield || {};
Elm.Minefield.make = function (_elm) {
   "use strict";
   _elm.Minefield = _elm.Minefield || {};
   if (_elm.Minefield.values) return _elm.Minefield.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var view = F2(function (address,minefield) {
      ...
      var rows = A2($List.map,function (row) {    return A2($Html.tr,_U.list([]),tiles(row));},minefield.field);
      return A2($Html.table,_U.list([]),rows);
   });
   return _elm.Minefield.values = {_op: _op
                                  ,Click: Click
                                  ,Mark: Mark
                                  ,Model: Model
                                  ,view: view
...
Elm.Minesweeper.make = function (_elm) {
   ...
   if (_elm.Minesweeper.values) return _elm.Minesweeper.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Minesweeper = Elm.Minesweeper.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   return _elm.Main.values = {_op: _op,app: app,main: main,init: init};
};
